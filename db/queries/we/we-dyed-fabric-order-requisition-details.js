...
exports.insertForPurchaseOrder = async (weDyedFabricOrderRequisition, weDyedFabricOrderRequisitionDetails, items) => {
    let queryResults = false;
    await sqlFun
        .insert(weDyedFabricOrderRequisitionDetailsTableName, {
            id: weDyedFabricOrderRequisitionDetails.weDyedFabricOrderRequisitionDetailsId,
            we_dyed_fabric_order_requisition_id: weDyedFabricOrderRequisitionDetails.weDyedFabricOrderRequisitionId,
            orders_requisitions_id: weDyedFabricOrderRequisitionDetails.ordersRequisitionsId,
            color_category_id: items.colorCategoryId,
            color_id: items.colorId,
            dyed_fabric_id: items.dyedFabricId,
...
exports.selectByRequisitionIdForWeAddRequisition = async (whereCluse) => {
    let queryResults = [];
...
exports.update = async (weDyedFabricOrderRequisitionDetails, whereCluse, trx = null) => {
    let queryResults = false;
    await sqlFun
        .update(
