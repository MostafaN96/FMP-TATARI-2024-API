...
exports.insert = async (wcTransitionBetweenOrdersRequisitionDetails, items) => {
  ...
  await sqlFun
    .insert(wcTransitionBetweenOrdersRequisitionDetailsTableName, {
      ...
      from_parent_wc_fabric_order_requisition_details_id: items.fromParentWcFabricOrderRequisitionDetailsId,
      from_wc_fabric_order_requisition_id: items.fromFabricOrderId,
      from_parent_wc_fabric_order_requisition_id: items.fromParentFabricOrderId,
      from_orders_requisitions_id: items.fromOrdersRequisitionsId,
      from_parent_orders_requisitions_id: items.fromParentOrdersRequisitionsId,
      wc_fabric_order_requisition_details_id: items.toWcFabricOrderRequisitionDetailsId,
      parent_wc_fabric_order_requisition_details_id: items.toParentWcFabricOrderRequisitionDetailsId,
      wc_fabric_order_requisition_id: wcTransitionBetweenOrdersRequisitionDetails.fabricOrderId,
      parent_wc_fabric_order_requisition_id: wcTransitionBetweenOrdersRequisitionDetails.parentFabricOrderId,
      orders_requisitions_id: wcTransitionBetweenOrdersRequisitionDetails.ordersRequisitionsId,
      parent_orders_requisitions_id: wcTransitionBetweenOrdersRequisitionDetails.parentOrdersRequisitionsId,
      price: items.price,
