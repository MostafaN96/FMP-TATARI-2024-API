...
const { 
  warehouseTableName, waTableName,
  waAddRequisitionTableName, waAddRequisitionDetailsTableName, 
  wcAddRequisitionTableName, wcAddRequisitionDetailsTableName,
  wcTableName, 
  waReconciliationRequisitionTableName, waReconciliationRequisitionDetailsTableName, 
  waReconciliationRequisitionDetailsWaTableName, 
  wbTransportRequisitionWbWaTableName, wbTransportRequisitionWbWaDetailsTableName, 
  wcReconciliationRequisitionTableName, wcReconciliationRequisitionDetailsTableName, 
  wcReconciliationRequisitionDetailsWcTableName, 
  wdTransportRequisitionWdWcTableName, wdTransportRequisitionWdWcDetailsTableName, 
  weAddRequisitionDetailsTableName, weTableName, 
  wdDyeingRequisitionDetailsTableName, wbManufacturingOutputTableName, 
  ...
  waExecuteOrderRequisitionTableName, waExecuteOrderRequisitionDetailsTableName, 
  waTransitionBetweenWHRequisitionTableName, waTransitionBetweenWHRequisitionDetailsTableName, 
  wdDyeingRequisitionTableName, wcTransitionBetweenWHRequisitionDetailsTableName, 
  wcTransitionBetweenWHRequisitionTableName, wcExecuteOrderRequisitionTableName,
   wcExecuteOrderRequisitionDetailsTableName, weExecuteOrderRequisitionTableName, 
