...
.orWhereIn(`${warehouseTableName}.id`, function () {
  this.select(`${wcExecuteOrderRequisitionTableName}.warehouse_id as id`)
...
exports.selectWhereInWe = async () => {
  ...
  .orWhereIn(`${warehouseTableName}.id`, function () {
    this.select(`${weExecuteOrderRequisitionTableName}.warehouse_id as id`)
