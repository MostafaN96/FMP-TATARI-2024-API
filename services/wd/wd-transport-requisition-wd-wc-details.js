...
const { wdTransportRequisitionWdWcDetailsWdTableName, wdTransportRequisitionWdWcDetailsTableName, wbTransportRequisitionWbWaTableName } = require("../../util/database-tables-name");
