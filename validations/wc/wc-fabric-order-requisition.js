...
exports.isValid = (wcFabricOrderRequisition) => {
    const wcFabricOrderRequisitionSchema = joi.object({
    ...
    const joiErrors = wcFabricOrderRequisitionSchema.validate(wcFabricOrderRequisition);
