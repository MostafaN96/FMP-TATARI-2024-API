...
exports.isValid = (wcTransitionBetweenWHRequisition) => {
    const wcTransitionBetweenWHRequisitionSchema = joi.object({
    ...
    const joiErrors = wcTransitionBetweenWHRequisitionSchema.validate(wcTransitionBetweenWHRequisition);
