...
exports.isValid = (wdTransportWcWdRequisition) => {
    const wdTransportWcWdRequisitionDetailsSchema = joi.object({
    ...
    const joiErrors = wdTransportWcWdRequisitionDetailsSchema.validate(wdTransportWcWdRequisition);
...
exports.isValidUpdate = (wdTransportWcWdRequisition) => {
    const wdTransportWcWdRequisitionDetailsSchema = joi.object({
