...
exports.isValid = (wdTransitionBetweenDyersRequisitionDetails) => {
    const wdTransitionBetweenDyersRequisitionDetailsSchema = joi.object({
    ...
    const joiErrors = wdTransitionBetweenDyersRequisitionDetailsSchema.validate(wdTransitionBetweenDyersRequisitionDetails);
...
exports.isValidUpdate = (wdTransitionBetweenDyersRequisitionDetails) => {
    const wdTransitionBetweenDyersRequisitionDetailsSchema = joi.object({
