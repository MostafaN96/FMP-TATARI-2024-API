...
exports.isValid = (weTransitionBetweenOrdersRequisition) => {
    const weTransitionBetweenOrdersRequisitionSchema = joi.object({
        ...
        items:joi.array().items( {
            ...
            colorCode: validations.joiText(0, 60),
    ...
    const joiErrors = weTransitionBetweenOrdersRequisitionSchema.validate(weTransitionBetweenOrdersRequisition);
