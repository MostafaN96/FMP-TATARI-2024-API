...
exports.isValid = (weExecuteOrderRequisitionDetails) => {
    const weExecuteOrderRequisitionDetailsSchema = joi.object({
        ...
        items: joi.array().items({
            ...
            dyedFabricCode: validations.joiNotRequiredText(0, 10000),
            dyedFabricName: validations.joiNotRequiredText(0, 10000),
    ...
    const joiErrors = weExecuteOrderRequisitionDetailsSchema.validate(weExecuteOrderRequisitionDetails);
...
exports.isValidUpdate = (weExecuteOrderRequisitionDetails) => {
    const weExecuteOrderRequisitionDetailsSchema = joi.object({
        weDyedFabricOrderRequisitionId: validations.joiText(15, 30),
        weDyedFabricOrderRequisitionDetailsId: validations.joiText(15, 30),
        weId: validations.joiText(15, 30),
