...
exports.isValid = (wbTransportRequisitionWbWaRequisition) => {
    const wbTransportRequisitionWbWaDetailsSchema = joi.object({
    ...
    const joiErrors = wbTransportRequisitionWbWaDetailsSchema.validate(wbTransportRequisitionWbWaRequisition);
...
exports.isValidUpdate = (wbTransportRequisitionWbWaRequisition) => {
    const wbTransportRequisitionWbWaDetailsSchema = joi.object({
        warehouseId: validations.joiText(15, 30),
        industryId: validations.joiText(15, 30),
