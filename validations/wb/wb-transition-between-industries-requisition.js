...
exports.isValid = (wbTransportBetweenIndustries) => {
    const wbTransportBetweenIndustriesRequisition = joi.object({
    ...
    const joiErrors = wbTransportBetweenIndustriesRequisition.validate(wbTransportBetweenIndustries);
