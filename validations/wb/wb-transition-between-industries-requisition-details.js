...
exports.isValid = (wbTransitionBetweenIndustriesRequisitionDetails) => {
    const wbTransitionBetweenIndustriesRequisitionDetailsSchema = joi.object({
        id: validations.joiText(15, 30),
        fromIndustryId: validations.joiText(15, 30),
        toIndustryId: validations.joiText(15, 30),
    ...
    const joiErrors = wbTransitionBetweenIndustriesRequisitionDetailsSchema.validate(wbTransitionBetweenIndustriesRequisitionDetails);
...
exports.isValidUpdate = (wbTransitionBetweenIndustriesRequisitionDetails) => {
    const wbTransitionBetweenIndustriesRequisitionDetailsSchema = joi.object({
