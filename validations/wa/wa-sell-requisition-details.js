...
exports.isValid = (waSellRequisition) => {
    const waSellRequisitionSchema = joi.object({
    ...
    const joiErrors = waSellRequisitionSchema.validate(waSellRequisition);
...
exports.isValidUpdate = (waSellRequisition) => {
    const waSellRequisitionSchema = joi.object({
        waSellRequisitionId: validations.joiText(15, 30),
