// Validation
const deliveryCarValidation = require("../../validations/general/delivery-car");

// Services
const deliveryCarService = require("../../services/general/delivery-car");
...
exports.select = async (request, response) => {
  ...
  // call service
  const results = await deliveryCarService.select();
...
exports.selectDeleted = async (request, response) => {
  ...
  // call service
  const results = await deliveryCarService.selectDeleted();
  response.status(200).json(results);
};
...
exports.create = async (request, response) => {
  ...
  // Validation
  if (!deliveryCarValidation.isValid(bodyPalod)) {
    // logging
    return response.status(400).json(constants.invalidDataResponse);
  }
  //   send data to service
  const results = await deliveryCarService.create(bodyPalod);
...
exports.update = async (request, response) => {
  ...
  bodyPalod.id = id
  const updateResults = await deliveryCarService.update(bodyPalod);
  // response
...
exports.delete = async (request, response) => {
  ...
  const results = await deliveryCarService.dalete(bodyPalod);
...
exports.restore = async (request, response) => {
  ...
  // call services
    const results = await deliveryCarService.restore(bodyPalod);
