// Validation
const consigmentYarnValidation = require("../../validations/general/consigment-yarn");

// Services
const consigmentYarnService = require("../../services/general/consigment-yarn");
...
exports.select = async (request, response) => {
  ...
  // call service
  const results = await consigmentYarnService.select();
...
exports.selectDeleted = async (request, response) => {
  ...
  // call service
  const results = await consigmentYarnService.selectDeleted();
  response.status(200).json(results);
};
...
exports.create = async (request, response) => {
  ...
  // Validation
  if (!consigmentYarnValidation.isValid(bodyPalod)) {
    // logging
    return response.status(400).json(constants.invalidDataResponse);
  }
  //   send data to service
  const results = await consigmentYarnService.create(bodyPalod);
...
exports.update = async (request, response) => {
  ...
  bodyPalod.id = id
  const updateResults = await consigmentYarnService.update(bodyPalod);
  // response
...
exports.delete = async (request, response) => {
  ...
  const results = await consigmentYarnService.dalete(bodyPalod);
...
exports.restore = async (request, response) => {
  ...
  // call services
    const results = await consigmentYarnService.restore(bodyPalod);
