// Validation
const dyeingServicesValidation = require("../../validations/general/dyeing-services");

// Services
const dyeingServicesService = require("../../services/general/dyeing-services");
...
exports.select = async (request, response) => {
  ...
  // call service
  const results = await dyeingServicesService.select();
...
exports.selectDeleted = async (request, response) => {
  ...
  // call service
  const results = await dyeingServicesService.selectDeleted();
  response.status(200).json(results);
};

exports.selectAdded = async (request, response) => {
    // logging
    const { id } = request.params;
  
    // call service
    const results = await dyeingServicesService.selectAdded(id);
    response.status(200).json(results);
  };

exports.selectNotIn = async (request, response) => {
    // logging
    const bodyPalod = request.body;
  
    // call service
    const results = await dyeingServicesService.selectNotIn(bodyPalod);
    response.status(200).json(results);
  };
...
exports.selectByDeying = async (request, response) => {
  ...
  // call service
  const results = await dyeingServicesService.selectByDeying(deyingId);
  response.status(200).json(results);
};
...
exports.create = async (request, response) => {
  ...
  // Validation
  if (!dyeingServicesValidation.isValid(bodyPalod)) {
    // logging
    return response.status(400).json(constants.invalidDataResponse);
  }
  //   send data to service
  const results = await dyeingServicesService.create(bodyPalod);
...
exports.update = async (request, response) => {
  ...
  bodyPalod.id = id
  const updateResults = await dyeingServicesService.update(bodyPalod);
  // response
...
exports.delete = async (request, response) => {
  ...
  const results = await dyeingServicesService.dalete(bodyPalod);
...
exports.restore = async (request, response) => {
  ...
  // call services
    const results = await dyeingServicesService.restore(bodyPalod);
