// Services
const waReconciliationRequisitionDetailsService = require("../../services/wa/wa-reconciliation-requisition-details");

// Modeles
const waReconciliationRequisitionDetailsModel = require("../../models/wa/wa-reconciliation-requisition-details");

// Validations
const waReconciliationRequisitionDetailsValidation = require("../../validations/wa/wa-reconciliation-requisition-details");
...
exports.create = async (request, response) => {
  ...
  const results = await waReconciliationRequisitionDetailsService.create(bodyPalod);
...
exports.selectByRequisitionId = async (request, response) => {
    ...
    // call service
    const results = await waReconciliationRequisitionDetailsService.selectByRequisitionId(id);
  ...
  exports.update = async (request, response) => {
    ...
    bodyPalod.id = id;
    const updateResults = await waReconciliationRequisitionDetailsService.update(bodyPalod);
    // response
